...
Return only LensPlan. Translate the query into allowed predicates; distinguish similarity from relationships. Reject attribution requests. Never emit SQL or mutate case state.
